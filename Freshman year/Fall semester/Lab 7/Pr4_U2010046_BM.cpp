/***    Full name: MEKHROL BAZAROV
		Student ID: U2010046
		Program statement:  4. Convert  function template for  problem 3. ***/
		// LOOK int main()  there might be int main4()
 #include <iostream>
using namespace std;
template<class T> //function template
 T maxNumber(T p, T q, T r)
{
...
int main()
{
	...
	while (1)
	{
		...
		case 1:
			...
			cin >> a >> b >> c; 
			cout << "The biggest number is = " << maxNumber(a, b, c) << endl << endl;
			break;
		case 2:
			float p, q, r;
			...
			cin >> p >> q >> r;
			cout << "The biggest number is = " << maxNumber(p, q, r) << endl << endl;
			break; 
		case 0: exit(0);
